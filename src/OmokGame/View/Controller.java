...
//							
                            ...
                            writer.flush();
                            model.stonesound();
                            if ((model.white_heightcheck(i, j) || model.white_widthcheck(i, j)
                                    || model.white_leftdiagcheck(i, j)
                                    || model.white_rightdiagcheck(i, j) || model.Wwinstate)) {
                                frame.play();
                        ...
                        if (model.getArr(i, j) == 0) {
                            ...
                            writer.flush();
                            model.stonesound();
                            if ((model.black_heightcheck(i, j) || model.black_widthcheck(i, j)
                                    || model.black_leftdiagcheck(i, j)
                                    || model.black_rightdiagcheck(i, j) || model.Bwinstate)) {
                                frame.play();
