...
public class ChessBoard {
    ...
    public boolean isSameTeam(int initialRow, int initialCol, int finalRow, int finalCol) {
        return (
                board[initialRow][initialCol] != null &&
                        ...
                        (board[initialRow][initialCol].getClass().getName().charAt(7 + 10) ==
                                board[finalRow][finalCol].getClass().getName().charAt(7 + 10))
        );
    }
    ...
    public boolean miniIsMoveValid(int initialRow, int initialCol, int finalRow, int finalCol) {
        ...
        for (int r = 0; r < 8; r++) {
            for (int c = 0; c < 8; c++) {
                ...
                String name = board[r][c].getClass().getName().substring(7 + 10);
    ...
    public boolean isMoveValid(int initialRow, int initialCol, int finalRow, int finalCol) {
        ...
        //movePiece(initialRow, initialCol, finalRow, finalCol);
		whiteInCheck = whiteKing.amIInCheck(board);
		blackInCheck = blackKing.amIInCheck(board);
        ...
        board[finalRow][finalCol] = temp;
        if (board[finalRow][finalCol] != null) {
            pieceMove = pieceMove.substring(0, pieceMove.length() - 2) + "x" + pieceMove.substring(pieceMove.length() - 2);
        }
    ...
    public void redo() {
        ...
        if (whiteToMove && redoObject.getRedoPiece().getClass().getName().charAt(7 + 10) == 'b') return;
        if (!whiteToMove && redoObject.getRedoPiece().getClass().getName().charAt(7 + 10) == 'w') return;
    ...
    public boolean isCheckmate() {
        ...
        for (int r = 0; r < 8; r++) {
            for (int c = 0; c < 8; c++) {
                if (board[r][c] == null) continue;
                if (whiteToMove && board[r][c].getClass().getName().charAt(7 + 10) == 'b') continue;
                if (!whiteToMove && board[r][c].getClass().getName().charAt(7 + 10) == 'w') continue;
